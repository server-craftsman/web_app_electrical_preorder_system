            ...
            <div className="mt-4 space-y-2">
              ...
              >
                <svg
                  ...
                  className="w-4 h-4 mr-2"
                >
                  <path d="M22.23 0h-20.46c-.974 0-1.77.796-1.77 1.77v20.459c0 .974.796 1.771 1.77 1.771h11.049v-8.896h-2.998v-3.467h2.998v-2.554c0-2.965 1.809-4.579 4.451-4.579 1.266 0 2.354.094 2.671.136v3.1l-1.832.001c-1.436 0-1.715.683-1.715 1.684v2.212h3.429l-.447 3.467h-2.982v8.896h5.847c.974 0 1.77-.797 1.77-1.771v-20.459c0-.974-.796-1.77-1.77-1.77z"/>
                </svg>
                LinkedIn
              </a>
            </div>
