...
const AboutPage: React.FC = () => {
  ...
  <p className="text-xl font-bold text-gray-700 leading-relaxed mb-8 max-w-3xl mx-auto">
    ...
    <span className="text-blue-500 font-semibold"> Pre-Order</span>. 
    Chúng tôi kết nối bạn với những sản phẩm công nghệ mới nhất 
    với mức giá <span className="text-green-500 font-semibold">ưu đãi nhất</span>.
  </p>
